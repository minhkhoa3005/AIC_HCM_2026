...
- `Local VLM response ... JSON object`: cập nhật branch `KIS_QA` mới nhất. Parser hiện chuẩn hóa JSON object, object bọc và array chứa object do model local sinh ra.
